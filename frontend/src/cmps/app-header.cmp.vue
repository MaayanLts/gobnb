<template >
  ...
  <div :class="headerClass" style="padding-bottom:10px">
    ...
    <div class="header" :class="stickyHeader">
...
export default {
  ...
  computed: {
    ...
    headerClass() {
      ...
      return (isDetailsHeader) ? 'like-details-layout' : 'main-layout sticky-header'
    },
    ...
    home() {
      ...
      if (isDetailsHeader)
      {
        return 'small-container sticky-header'
      } else return 'none'
    },
    stickyHeader() {
      const isDetailsHeader = this.$route.name === 'stay-details'
