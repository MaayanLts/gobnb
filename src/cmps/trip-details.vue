    ...
    <div class="trip-details">
      ...
      <el-dialog v-model="dialogVisible" width="30%">
        ...
        <div class="reservation">
          <h3 class="bold">You're going to {{ stay.address.city }}!</h3>
          <!-- <div class="txt-holder"> </div> -->
          <h4 class="code-holder">Reservation Code: <span class="code-reservation"> {{ reservationCode }}</span></h4>
          
          <div class="reservation-data-holder">

            <div class="host-info-modal-container">
              <div class="reservation-stay-img-container">
                <img class="stay-img" :src="imageUrl()" alt="" srcset="">
              </div>
              <div class="img-txt-holder-left-bar">
                <div class="host-name-img-container">
                  <img class="host-img" :src="stay.host.pictureUrl " alt="" srcset="">
                  <span class="host-reservation">Your host is {{ stay.host.fullname }}</span>
                </div>
                <p class="info-reservation-right-bar">Thank you so much for choosing to stay
        ...
        <template #footer>
          <div class="dialog-footer">
            <el-button @click="goToMyTrip()" style="width: 100px; height: 30px">Ok
            </el-button>
          </div>
        </template>
      </el-dialog>
...
export default {
  ...
  methods: {
    imageUrl() {
      return `${import.meta.env.BASE_URL}images/${ this.stay.imgUrls[0] }`
    },
    reserve() {
      const trip = {
